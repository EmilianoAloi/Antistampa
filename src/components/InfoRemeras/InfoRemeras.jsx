            ...
            <Container >
                <Stack color='white' fontFamily='Roboto'>
                    ...
                    <Typography component='h3' sx={{textAlign:'center',  fontSize: { xs: '0.8rem', sm: '1.5rem' } }} >
                        ...
                        Talles reales para adultos: Desde XS hasta XXXL.<br /><br />
                ...
                <Stack alignItems='center' mt={5} gap={3}>
                    ...
                    <Typography component='h3' color='white' fontWeight={500} sx={{ fontSize: { xs: '1.2rem', sm: '2rem' } }} >14 COLORES DISPONIBLES</Typography>
